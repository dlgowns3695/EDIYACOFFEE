...
function Ambition() {
  ...
  return (
    <div className="w-full h-[3100px] px-6 md:h-[1885px] bg-white flex justify-center relative overflow-hidden ">
      ...
      <div className="relative w-[1200px] h-full">
        ...
        {/* 상생협력 */}
        <div className="flex justify-between mt-[37px] relative top-[1000px] pl-[9.4rem] md:pl-0  md:top-[282px] md:left-0 md:mt-0 ">
    ...
    <div className="w-full h-[2600px] px-6 custom1200:h-[2100px]  flex justify-center ">
      ...
      <div data-aos="fade-up"  className="w-[1200px] h-full ">
        ...
        <div className='flex flex-col md:hidden gap-32'>
          ...
          <div className='flex justify-start items-center gap-12 px-6'>
            <div>
              <img className="block object-cover" src={`${process.env.PUBLIC_URL}/Philosophy02Mobile.png`} alt="Philosophy Icon 2" />
            </div>
            <div>
              <h4 className="font-semibold text-[36px]  text-[#222222] mb-[12px]">
                신나고 행복한 즐거운 기업
          ...
          <div className='flex justify-start items-center gap-12 px-6'>
            <div>
              <img className="block object-cover" src={`${process.env.PUBLIC_URL}/Philosophy03Mobile.png`} alt="Philosophy Icon 3" />
            </div>
            <div>
              <h4 className="font-semibold text-[36px]  text-[#222222] mb-[12px]">
                사람을 생각하는 따뜻한 기업
