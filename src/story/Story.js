    ...
    <div className="w-full h-[1885px] bg-white flex justify-center relative">
      ...
      <div className="relative w-[1200px] h-full">
        ...
        <div className="mt-[386px]">
          <h4 className="text-[52px]  leading-[62px] ">
            Always Beside You,<br />
            <span className='font-semibold'>이디야커피는 언제나 당신 곁에 함께 합니다.</span> 
          </h4>
          <p className="text-black text-[30px] font-semibold mt-[40px] mb-[20px]">
            커피 한잔의 진심
          </p>
          <p className="text-[24px] leading-[37px] text-black">
        ...
        <div className="flex justify-between mt-[282px]">
          <div className="text-black">
            <h4 className="text-[52px] text-[#243c84] leading-[62px] ">
              함께 행복하기<br />
              <span className='font-semibold'>위한 상생협력</span> 
            </h4>
            <p className="text-[24px] leading-[39px] mt-[72px]">
        ...
        {/* 인물사진 */}
        <div className='absolute top-[940px] left-[600px]'>
    ...
    <div className="w-full h-[700px] bg-[#edeef2] flex justify-center">
      <div className="w-[1200px] h-full flex flex-col items-center">
        <div className="mt-[116px] text-center">
          <h4 className="text-[52px] mb-[12px]">이디야의 <span className='font-semibold'>핵심가치</span></h4>
          <p className="text-black text-[24px] font-semibold">
            고객과 가맹점주, 협력사의 상생의 가치를 실천합니다.
          </p>
        </div>

        <div className="mt-[110px] flex justify-center gap-32">
          {[
            {
...
function Management() {
  return (
    <div className="w-full h-[2100px] flex justify-center relative">
      ...
      <div className="w-[1200px] h-full bg-green-100">
        {/* 이디야의 경영철학 */}
        ...
        <div className="relative top-[0] left-[400px]">
          <div className="absolute top-[74px] left-[563px]">
            <h4 className="font-semibold text-[26px] text-black">
            신나고 행복한 즐거운 기업
            </h4>
            <p className="text-black text-[18px] leading-[26px]">
          ...
          <img className="absolute top-[2px] left-[314px] object-cover" src={`${process.env.PUBLIC_URL}/Philosophy02.png`} alt="Philosophy Icon 1" />
        </div>
        ...
        {/* 글로벌 생산성 1위 */}
        <div className="bg-red-100 relative w-full flex flex-col items-center absolute top-[848px] text-center">
          <h4 className="text-[52px] preten-font300">글로벌 생산성 1위</h4>
          <h4 className="text-[48px] font-semibold mb-[50px]">커피 전문기업 이디야 커피</h4>
          <p className="text-black preten-font300 ">
        ...
        {/* 로고, 메인컬러 */}
        <div className="flex justify-center gap-[57px] absolute top-[1478px]">
          {/* 왼쪽 */}
